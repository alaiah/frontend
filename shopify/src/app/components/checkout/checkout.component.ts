...
export class CheckoutComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.checkoutFormGroup = this.formBuilder.group({
      customer: this.formBuilder.group({
        firstName: new FormControl('', [Validators.required, Validators.minLength(2), ShopifyValidators.onlyWhitespace]),
        lastName: new FormControl('', [Validators.required, Validators.minLength(2)]),
        email: new FormControl('', {
          validators: [Validators.required, Validators.pattern("^[a-zA-Z0-9+_.-]+@[a-zA-Z0-9.-]+$")],
          asyncValidators: ServerSideValidator.checkUniqueEmail(this.checkoutService), updateOn: 'blur'
        })
      }),
      shippingAddress: this.formBuilder.group({
        street: new FormControl('', [Validators.required, Validators.minLength(2), ShopifyValidators.onlyWhitespace]),
        city: new FormControl('', [Validators.required, Validators.minLength(2), ShopifyValidators.onlyWhitespace]),
        state: new FormControl('', [Validators.required]),
        zipCode: new FormControl('', [Validators.required, Validators.minLength(2), ShopifyValidators.onlyWhitespace]),
      ...
      creditCard: this.formBuilder.group({
        ...
        nameOnCard: new FormControl('', [Validators.required, Validators.minLength(2), ShopifyValidators.onlyWhitespace]),
    ...
    if (authenticated) {
      ...
      this.checkoutFormGroup.get('customer.firstName').setValue(userClaims.given_name);
      this.checkoutFormGroup.get('customer.firstName').disable();

      this.checkoutFormGroup.get('customer.lastName').setValue(userClaims.family_name);
  ...
  get creditCardType() { return this.checkoutFormGroup.get('creditCard.creditCardType'); }
